      ...
      blocks: [
        ...
        { type: "divider" },
        {
          ...
          text: {
            ...
            text:
              ...
              "• *[플로팅 배너]* 최대 3일\n" +
              "• *[관심종목탭]* 최대 7일\n" +
              "⚠️ 같은 월 2회 이상 유사배너 노출 시, 3번째부터 후순위 변경 가능 (2순위 신청자가 있을 경우에 한함, 유사 여부는 관리자 판단)",
          },
        },
        { type: "divider" },
        {
        ...
        { type: "divider" },
        {
          ...
          text: {
            ...
            text:
              "*5. 등록 시 주의사항*\n" +
              "• 모든 신청건이 확정되는 것은 아닙니다. 본신청 마감(마지막 목요일) 이후 익월 캘린더에 확정본만 남게 되며, 추가신청 마감(익월 두 번째 목요일) 이후 해당월 최종 확정본만 남게 됩니다.\n" +
              "• 추후 상품종류(국내주식, 해외주식 등), 목적(세일즈, 제도개선 안내 등), 전환율 등 운영상황에 따라 우선순위 기준이 변경될 수 있습니다.",
          },
        },
      ],
    },
